            ...
            <footer className="mt-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-base font-medium text-gray-200">CEO, Tuple</div>
                </div>
              </div>
            </footer>
          </blockquote>
            ...
            <footer className="mt-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-base font-medium text-gray-200">CEO, Workcation</div>
                </div>
              </div>
            </footer>
          </blockquote>
              ...
              <footer className="mt-8">
                <div className="flex">
                  ...
                  <div className="ml-4 lg:ml-0">
                    <div className="text-base font-medium text-gray-900">Judith Black</div>
                    <div className="text-base font-medium text-gray-600">CEO, Tuple</div>
                  </div>
                </div>
              </footer>
            </blockquote>
