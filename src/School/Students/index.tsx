            ...
            <div className="grid grid-cols-1 gap-y-6 gap-x-4">
              ...
              <div className="sm:col-span-full">
                <label
                  ...
                  className="block text-sm font-medium text-gray-700"
                >
                  Mobile Number 2 <span className="text-gray-400 ml-3">(optional)</span>
                </label>
                <div className="mt-1">
                  <input
                    onChange={handleChange}
              ...
              <div className={`sm:col-span-${state.state_of_origin ? "3" : "full"}`}>
                <label
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-1">
                    ...
                    >
                      ...
                      {Nigeria.map((niger) => (
                        <>
                          {niger.state === state.state_of_origin &&
