  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center sm:py-12 sm:px-6 lg:px-8 px-4 col-span-1">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        />
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">{staffData?.full_name}</h2>
        <h2 className="mt-6 text-center text-xl font-extrabold text-gray-900">Please Change Your Password</h2>
        {/* <h2 className="mt-1 text-center text-xl text-gray-900">Or <span className="text-sm text-blue-600"><Link to={`/${slug}/login`}>Sign In To Your Account</Link></span></h2> */}
      </div>
